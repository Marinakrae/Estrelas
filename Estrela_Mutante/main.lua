...
function love.draw()
    ...
    rMaior = 100
    nPontas = 100
    saltos = math.floor(posX / 3)

    for n = 1, nPontas do
        ponto1X = DefinePontoX(posX + xCentro, yCentro, rMaior, anguloRotacao + 360 * saltos * (n - 1) / nPontas)
        ponto1Y = DefinePontoY(posX + xCentro, yCentro, rMaior, anguloRotacao + 360 * saltos * (n - 1) / nPontas)
        ponto2X = DefinePontoX(posX + xCentro, yCentro, rMaior, anguloRotacao + (360 * saltos * n) / nPontas)
        ponto2Y = DefinePontoY(posX + xCentro, yCentro, rMaior, anguloRotacao + (360 * saltos * n) / nPontas)
